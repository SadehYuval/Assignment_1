...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o bin/SelectionPolicy.o bin/MandatesSelectionPolicy.o bin/EdgeWeightSelectionPolicy.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o bin/SelectionPolicy.o bin/MandatesSelectionPolicy.o bin/EdgeWeightSelectionPolicy.o
